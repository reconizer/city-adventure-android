...
import pl.reconizer.unfold.data.network.interceptors.AuthenticationInterceptor
...
class NetworkModule {
    ...
    companion object {
        private const val BASE_API_URL = "http://seeqr-427315431.eu-west-1.elb.amazonaws.com:80/"
        //private const val BASE_API_URL = "http://192.168.1.104:4008/"
    }
